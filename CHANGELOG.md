...
* wip [Pagan Gazzard]
* Move should be and is running release onto the device app relationship [Pagan Gazzard]
* Convert `device belongs to application` into a link table [Pagan Gazzard]
