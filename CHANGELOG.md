...
* Ingore unfixed [Dan Goodman]
* Back to trivy [Dan Goodman]
* Add curl [Dan Goodman]
* Grype [Dan Goodman]
* Critical [Dan Goodman]
* Exit code [Dan Goodman]
* Removed report [Dan Goodman]
* Try progress [Dan Goodman]
* Test exiting fail [Dan Goodman]
* Fix artifact [Dan Goodman]
* JSON format [Dan Goodman]
* Fix yaml [Dan Goodman]
* Add artifact download [Dan Goodman]
* Output report [Dan Goodman]
* Try higher level [Dan Goodman]
* Remove sudo [Dan Goodman]
* Add trivy [Dan Goodman]
