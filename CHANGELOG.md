...
* Optimize application release pinning use a single GET request [Thodoris Greasidis]
* service-installs: Avoid an extra image-service expand [Thodoris Greasidis]
* Optimize application release pinning [Thodoris Greasidis]
