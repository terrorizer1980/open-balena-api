...
>(
	fn: T,
	opts: MultiCacheMemoizeeOpts &
		Required<Pick<MultiCacheMemoizeeOpts, 'undefinedAs'>>,
	sharedCacheOpts?: Partial<Pick<MultiCacheMemoizeeOpts, 'max' | 'maxAge'>>,
): MemoizedFn<T>;
export function multiCacheMemoizee<
